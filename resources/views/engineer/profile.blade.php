...
<div id="profile-content" style="display:none;max-width:860px;margin:0 auto;">
    ...
    <div style="background:#fff;border:1.5px solid #e5e7eb;border-radius:1.5rem;
        ...
        {{-- Cover strip --}}
        <div style="height:100px;background:linear-gradient(135deg,#0ea5e9,#6366f1,#8b5cf6);position:relative;"></div>

        {{-- Avatar + info --}}
        <div style="padding:0 1.75rem 1.75rem;position:relative;">
            <div id="ep-avatar-wrap" style="margin-top:-50px;margin-bottom:1rem;"></div>
...
async function loadProfile() {
    try {
        ...
        if (u.profile_photo_url) {
            ...
            const init = (u.name??'E')[0].toUpperCase();
